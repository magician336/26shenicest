...
{
    /// <summary>
    /// 单人模式用的网络桥接——替代 FusionGameplayBridge。
    ...
    public class LocalGameplayBridge : MonoBehaviour, IGameplayTransport
    {
        ...
        private void Start()
        {
            ...
            Debug.Log("[LocalGameplayBridge] 单人模式就绪。Tab 切换角色。");
        }
        ...
        private void SwitchRole()
        {
            ...
            Debug.Log($"[单人] 角色切换 → {newRole}（{(newRole == SessionRole.Host ? "女儿端" : "母亲端")}）");
        }
