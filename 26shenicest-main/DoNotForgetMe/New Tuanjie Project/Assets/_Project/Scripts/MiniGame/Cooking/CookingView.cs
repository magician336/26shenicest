...
namespace DoNotForgetMe.MiniGame.Cooking
{
    ...
    public class CookingView : MonoBehaviour
    {
        ...
        [SerializeField] private Image _motherWaitingImage;
        ...
        [SerializeField] private Image _daughterWaitingImage;
        ...
        public Image MotherWaitingImage => _motherWaitingImage;
        ...
        public Image DaughterWaitingImage => _daughterWaitingImage;
